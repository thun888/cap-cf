/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 20011b72af0cd17a188ed09d0b5ab83b)
// Runtime types generated with workerd@1.20260625.1 2026-06-27 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	ENABLE_ASSETS_SERVER: "";
	WIDGET_VERSION: "3";
	WASM_VERSION: "0.1";
	ADMIN_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLE_ASSETS_SERVER" | "WIDGET_VERSION" | "WASM_VERSION" | "ADMIN_KEY" | "CACHE_BACKEND">> {}
}
